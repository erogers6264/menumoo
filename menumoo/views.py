...
from .utils import getUserID, getUserInfo, createUser
...
#  Create a view decorator to see if the user is logged in
...
def fbdisconnect():
    ...
    url = 'https://graph.facebook.com/%s/permissions?%s' % (facebook_id,
                                                            access_token)
    h = httplib2.Http()
